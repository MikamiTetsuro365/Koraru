...
if ($text !== null) {
    ...
    try {
        ...
        // Update status.
        $_SESSION['to']->postMultipart('statuses/update_with_media', array('status' => $text , '@media[]' => $file ));
...
<body>
  ...
  <form action="" method="post">
    <textarea name="text" rows="8" cols="50">&#13;| #コラる http://sima-tetteke.sakura.ne.jp/generator/KoraruSample/index.html</textarea><br>
